                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <div class="row">
                                <div class="col-10">
                                    <form action="http://10.26.6.221/cycletime/report" method="GET">
                                        <div class="row">
                                        ...
                                        foreach ($batchs as $batch): ?>
                                            <?php if (!empty($batch['no_spk'])): ?>
                                                <tr>
                                                    ...
                                                    <td><?= $batch['no_spk'] ?></td>
                                                    <td>
                                                        <a href="http://10.26.6.221/cycletime/report/<?= $batch['no_spk'] ?>" class="btn btn-primary" title="Detail" target="__blank"><i class="fas fa-print"></i></a>
                                                    </td>
                                                </tr>
                                            <?php endif; ?>
                                        <?php endforeach; ?>
