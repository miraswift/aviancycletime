                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <div class="row">
                                <div class="col-10">
                                    <form action="<?= base_url() ?>/cycletime/reportcycletime" method="GET">
                                        <div class="row">
                                    ...
                                    <tbody>
                                        ...
                                        foreach ($batchs as $batch): ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="<?= base_url() ?>/cycletime/reportcycletime/<?= $batch['no_batch'] ?>" class="btn btn-primary" title="Detail"><i class="fas fa-eye"></i></a>
                                                </td>
                                            </tr>
                                        <?php endforeach; ?>
                                    </tbody>
